...
- **Автоматическая установка сетей** — автоматически устанавливает рыболовные сети (работает по команде `/fn`)
...
- `/fh` - включить/выключить скрипт
- `/fe` - начать рыбалку
- `/fn` - установить рыболовные сети
